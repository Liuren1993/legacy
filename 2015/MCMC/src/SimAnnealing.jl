...
function simannealing!{L<:Real,I<:Real,B<:Real}(labelfield::Vector{L}, img::Matrix{I}, alpha::Real, beta::Vector{B}, T::Real)
    ...
    for i = 1:r, for j = 1:c
        ...
        for l = 1:labelNum
            conditionalProb[l] = exp(energyFunc[l]/T)/(sum(exp(energyFunc/T)))
        end
...
# exports
export pairwise, simannealing!, clique
